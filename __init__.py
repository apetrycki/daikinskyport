...
DATA_DAIKINSKYPORT = "daikinskyport"
...
def setup_daikinskyport(hass, config):
...
def setup(hass, config):
    ...
    hass.data[DATA_DAIKINSKYPORT] = DaikinSkyportData(hass.config.path(DAIKINSKYPORT_CONFIG_FILE))

    setup_daikinskyport(hass, config)
